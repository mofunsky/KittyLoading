package com.reasono.kittyloading;
...
public class ProgressWheel extends View {
    ...
    /**
     * increment by hundred mark
     * @param percent
     * add by reasono
     */
    public void incrementProgressByHundredmark(int percent) {
        isSpinning = false;
        progress = Math.round((float)percent * 360 / 100);
        setText(percent + "%");
        spinHandler.sendEmptyMessage(0);
    }
	/**
